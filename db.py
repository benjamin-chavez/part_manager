...
# db.insert("part1", "customer1", "retailer1", "100")
# db.insert("part2", "customer2", "retailer2", "200")
# db.insert("part3", "customer3", "retailer3", "300")
# db.insert("part4", "customer4", "retailer4", "400")
# db.insert("part5", "customer5", "retailer5", "500")